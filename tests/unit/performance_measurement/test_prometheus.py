...
def test_prometheus_vector_range_parsing_and_unavailable_metrics() -> None:
    metrics = [
...
def test_http_failure_is_unavailable_not_zero() -> None:
...
def test_non_finite_prometheus_sample_is_rejected() -> None:
