...
def build_parser() -> argparse.ArgumentParser:
    ...
    report.add_argument("--embedding-model-revision", default=DEFAULT_EMBEDDING_MODEL_REVISION)
    report.add_argument("--embedding-template-version", default=DOCUMENT_TEMPLATE_VERSION)
